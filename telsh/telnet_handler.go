...
import (
	...
	"github.com/wait4pumpkin/go-telnet"
...
func connect(ctx telnet.Context, writer io.Writer, reader io.Reader) chan struct{} {
	logger := ctx.Logger()
